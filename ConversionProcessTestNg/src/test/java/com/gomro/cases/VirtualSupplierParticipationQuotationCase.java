...
public class VirtualSupplierParticipationQuotationCase extends BaseTester {
...
//		String jsString = "document.getElementsByClassName('layui-input input-required expire').removeAttribute('readonly');";
...
//		sendKeys(pageName, "报价有效期", "2030-01-22 00:00:00");
	...
	public static Object[][] datas() {
		List<ParticipateInAQuoteData> list = ExcelUtils.read("src/test/resources/VirtualSupplierParticipationQuotation.xlsx",
